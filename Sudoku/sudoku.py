...
class Sudoku:
    ...
    def get_row(self, row_index):
        ...
        for sub_board_index in range(3):
            complete_row = np.concatenate((complete_row, self.boards[sub_board + sub_board_index][row_index % 3]),
                                          axis=None)
        return complete_row
    ...
    def get_row_score(self, row_index: int) -> int:
        ...
        row_score = reduce(operator.add, [occurrence for [value, occurrence] in
    ...
    def get_column_score(self, column_index: int) -> int:
        ...
        column_score = reduce(operator.add, [occurrence for [value, occurrence] in
    ...
    def calculate_fitness(self) -> float:
        ...
        for index in range(9):
            ...
            total_sub_boards_unique_occurrencs += self.get_sub_board_score(index)
